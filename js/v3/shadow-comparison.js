(function (root, factory) {
  ...
  function compareProductProviders(nextSummary, legacySummary) {
    var next = nextSummary || {};
    ...
    var differences = fields.map(function (field) {
      return difference(field, legacy[field], next[field]);
    });
    return Object.freeze({
      ready: differences.every(function (entry) { return entry.equal; }),
      differences: Object.freeze(differences),
      next: Object.freeze(Object.assign({}, next))
    });
  }
  ...
  return {
    ...
    compareProductProviders: compareProductProviders
  };
});
