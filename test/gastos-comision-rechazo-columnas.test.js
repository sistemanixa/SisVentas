...
const app = fs.readFileSync(path.join(__dirname, '..', 'js', 'app.v3.2.0.js'), 'utf8');
...
assert(index.includes('resizable-tables.js?v=3.2.0'), 'La app debe cargar la copia publicada del controlador de grillas.');
