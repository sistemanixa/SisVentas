...
const app = fs.readFileSync('js/app.v2.0.275.js', 'utf8');
const service = fs.readFileSync('cotizador/index.js', 'utf8');

assert(index.includes('app.v2.0.275.js'));
assert(index.includes('version.v2.0.275.js'));
assert(app.includes("VERSION: 'v2.0.275-firebase'"));
...
console.log('v2.0.275: Mercado Libre distingue catálogo de publicación');
