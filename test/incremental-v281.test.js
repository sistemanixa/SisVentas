...
const app = fs.readFileSync(path.join(root, 'js', 'app.v2.0.281.js'), 'utf8');
...
test('la publicación v2.0.281 mantiene referencias coherentes', () => {
  assert.match(index, /app\.v2\.0\.281\.js/);
  assert.match(index, /version\.v2\.0\.281\.js/);
  assert.match(worker, /sisventas-v2\.0\.281/);
});
