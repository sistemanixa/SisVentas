...
test('la integración conserva v2.0.286 como única aplicación activa', () => {
  ...
  assert.equal(activeAppScripts[0][1], 'js/app.v2.0.286.js');
...
test('el núcleo v3 se carga después de la aplicación actual y en orden seguro', () => {
  ...
  let previousIndex = indexSource.indexOf('js/app.v2.0.286.js');
