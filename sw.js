/* SisVentas NIXA - Service Worker v2.0.281
   Versión v2.0.281. Estrategia: red primero con cache de respaldo. */
const CACHE = 'sisventas-v2.0.281';
const SHELL = [
  './',
  './index.html',
  './css/app.css',
