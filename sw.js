/* SisVentas NIXA - Service Worker v2.0.200
   Versión v2.0.200. Estrategia: red primero con cache de respaldo. */
const CACHE = 'sisventas-v2.0.200';
const SHELL = [
  './',
  './index.html',
  './css/app.css',
