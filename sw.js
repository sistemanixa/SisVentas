/* SisVentas NIXA - Service Worker v2.0.275
   Versión v2.0.275. Estrategia: red primero con cache de respaldo. */
const CACHE = 'sisventas-v2.0.275';
const SHELL = [
  './',
  './index.html',
  './css/app.css',
