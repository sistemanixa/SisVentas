/* SisVentas NIXA - Service Worker v2.0.254
   Versión v2.0.254. Estrategia: red primero con cache de respaldo. */
const CACHE = 'sisventas-v2.0.254';
const SHELL = [
  './',
  './index.html',
  './css/app.css',
