/* SisVentas NIXA - Service Worker v2.0.290
   Versión v2.0.290. Estrategia: red primero con cache de respaldo. */
const CACHE = 'sisventas-v2.0.290';
const SHELL = [
  './',
  './index.html',
  './css/app.css',
