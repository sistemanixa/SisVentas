/* SisVentas NIXA - Service Worker v2.0.283
   Versión v2.0.283. Estrategia: red primero con cache de respaldo. */
const CACHE = 'sisventas-v2.0.283';
const SHELL = [
  './',
  './index.html',
  './css/app.css',
