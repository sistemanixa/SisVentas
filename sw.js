/* SisVentas NIXA - Service Worker v2.0.271
   Versión v2.0.271. Estrategia: red primero con cache de respaldo. */
const CACHE = 'sisventas-v2.0.271';
const SHELL = [
  './',
  './index.html',
  './css/app.css',
