/* SisVentas NIXA - Service Worker v2.0.220
   Versión v2.0.220. Estrategia: red primero con cache de respaldo. */
const CACHE = 'sisventas-v2.0.220';
const SHELL = [
  './',
  './index.html',
  './css/app.css',
