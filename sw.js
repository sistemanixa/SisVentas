/* SisVentas NIXA - Service Worker v2.0.307
   Versión v2.0.307. Estrategia: red primero con cache de respaldo. */
const CACHE = 'sisventas-v2.0.307';
const SHELL = [
  './',
  './index.html',
  './css/app.css',
