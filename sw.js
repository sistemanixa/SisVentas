/* SisVentas NIXA - Service Worker v2.0.197
   Versión v2.0.197. Estrategia: red primero con cache de respaldo. */
const CACHE = 'sisventas-v2.0.197';
const SHELL = [
  './',
  './index.html',
  './css/app.css',
