/* SisVentas NIXA - Service Worker v2.0.299
   Versión v2.0.299. Estrategia: red primero con cache de respaldo. */
const CACHE = 'sisventas-v2.0.299';
const SHELL = [
  './',
  './index.html',
  './css/app.css',
