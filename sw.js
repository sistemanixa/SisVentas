/* SisVentas NIXA - Service Worker v2.0.218
   Versión v2.0.218. Estrategia: red primero con cache de respaldo. */
const CACHE = 'sisventas-v2.0.218';
const SHELL = [
  './',
  './index.html',
  './css/app.css',
