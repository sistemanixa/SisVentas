/* SisVentas NIXA - Service Worker v2.0.289
   Versión v2.0.289. Estrategia: red primero con cache de respaldo. */
const CACHE = 'sisventas-v2.0.289';
const SHELL = [
  './',
  './index.html',
  './css/app.css',
