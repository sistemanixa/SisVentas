/* SisVentas NIXA - Service Worker v2.0.276
   Versión v2.0.276. Estrategia: red primero con cache de respaldo. */
const CACHE = 'sisventas-v2.0.276';
const SHELL = [
  './',
  './index.html',
  './css/app.css',
