/* SisVentas NIXA - Service Worker v2.0.311
   Versión v2.0.311. Estrategia: red primero con cache de respaldo. */
const CACHE = 'sisventas-v2.0.311';
const SHELL = [
  './',
  './index.html',
  './css/app.css',
