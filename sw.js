/* SisVentas NIXA - Service Worker v2.0.277
   Versión v2.0.277. Estrategia: red primero con cache de respaldo. */
const CACHE = 'sisventas-v2.0.277';
const SHELL = [
  './',
  './index.html',
  './css/app.css',
