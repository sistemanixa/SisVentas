/* SisVentas NIXA - Service Worker v2.0.297
   Versión v2.0.297. Estrategia: red primero con cache de respaldo. */
const CACHE = 'sisventas-v2.0.297';
const SHELL = [
  './',
  './index.html',
  './css/app.css',
