/* SisVentas NIXA - Service Worker v2.0.205
   Versión v2.0.205. Estrategia: red primero con cache de respaldo. */
const CACHE = 'sisventas-v2.0.205';
const SHELL = [
  './',
  './index.html',
  './css/app.css',
