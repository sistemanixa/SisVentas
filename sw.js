/* SisVentas NIXA - Service Worker v2.0.270
   Versión v2.0.270. Estrategia: red primero con cache de respaldo. */
const CACHE = 'sisventas-v2.0.270';
const SHELL = [
  './',
  './index.html',
  './css/app.css',
