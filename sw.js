/* SisVentas NIXA - Service Worker v2.0.226
   Versión v2.0.226. Estrategia: red primero con cache de respaldo. */
const CACHE = 'sisventas-v2.0.226';
const SHELL = [
  './',
  './index.html',
  './css/app.css',
