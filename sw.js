/* SisVentas NIXA - Service Worker v2.0.248
   Versión v2.0.248. Estrategia: red primero con cache de respaldo. */
const CACHE = 'sisventas-v2.0.248';
const SHELL = [
  './',
  './index.html',
  './css/app.css',
