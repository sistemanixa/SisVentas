/* SisVentas NIXA - Service Worker v2.0.301
   Versión v2.0.301. Estrategia: red primero con cache de respaldo. */
const CACHE = 'sisventas-v2.0.301';
const SHELL = [
  './',
  './index.html',
  './css/app.css',
