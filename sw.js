/* SisVentas NIXA - Service Worker v2.0.246
   Versión v2.0.246. Estrategia: red primero con cache de respaldo. */
const CACHE = 'sisventas-v2.0.246';
const SHELL = [
  './',
  './index.html',
  './css/app.css',
