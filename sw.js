/* SisVentas NIXA - Service Worker v2.0.198
   Versión v2.0.198. Estrategia: red primero con cache de respaldo. */
const CACHE = 'sisventas-v2.0.198';
const SHELL = [
  './',
  './index.html',
  './css/app.css',
