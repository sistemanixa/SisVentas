/* SisVentas NIXA - Service Worker v3.6.19
   Estrategia: red primero con cache de respaldo. */
const CACHE = 'sisventas-v3.6.19';
const SHELL = [
  './',
  './index.html',
  './css/app.css?v=3.6.19',
  './css/v3-preview.css',
  './js/app.js',
  './js/modules/budget-proposals.js?v=3.6.19',
  ...
  './js/modules/chat-access.js',
  './js/modules/security-storage.js',
  './js/modules/catalog-cart-review.js',
  './js/modules/ai-learning.js',
  './js/modules/budget-exterior.js?v=3.6.19',
  './js/modules/product-query-guard.js?v=3.6.19',
