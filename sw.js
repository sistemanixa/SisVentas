/* SisVentas NIXA - Service Worker v2.0.284
   Versión v2.0.284. Estrategia: red primero con cache de respaldo. */
const CACHE = 'sisventas-v2.0.284';
const SHELL = [
  './',
  './index.html',
  './css/app.css',
