/* SisVentas NIXA - Service Worker v2.0.295
   Versión v2.0.295. Estrategia: red primero con cache de respaldo. */
const CACHE = 'sisventas-v2.0.295';
const SHELL = [
  './',
  './index.html',
  './css/app.css',
