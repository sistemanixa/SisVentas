/* SisVentas NIXA - Service Worker v2.0.279
   Versión v2.0.279. Estrategia: red primero con cache de respaldo. */
const CACHE = 'sisventas-v2.0.279';
const SHELL = [
  './',
  './index.html',
  './css/app.css',
