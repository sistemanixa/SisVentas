/* SisVentas NIXA - Service Worker v2.0.255
   Versión v2.0.255. Estrategia: red primero con cache de respaldo. */
const CACHE = 'sisventas-v2.0.255';
const SHELL = [
  './',
  './index.html',
  './css/app.css',
