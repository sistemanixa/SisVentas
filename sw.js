/* SisVentas NIXA - Service Worker v2.0.296
   Versión v2.0.296. Estrategia: red primero con cache de respaldo. */
const CACHE = 'sisventas-v2.0.296';
const SHELL = [
  './',
  './index.html',
  './css/app.css',
