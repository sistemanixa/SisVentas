/* SisVentas NIXA - Service Worker v2.0.292
   Versión v2.0.292. Estrategia: red primero con cache de respaldo. */
const CACHE = 'sisventas-v2.0.292';
const SHELL = [
  './',
  './index.html',
  './css/app.css',
