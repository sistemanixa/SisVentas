/* SisVentas NIXA - Service Worker v2.0.272
   Versión v2.0.272. Estrategia: red primero con cache de respaldo. */
const CACHE = 'sisventas-v2.0.272';
const SHELL = [
  './',
  './index.html',
  './css/app.css',
