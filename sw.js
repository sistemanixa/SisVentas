/* SisVentas NIXA - Service Worker v2.0.231
   Versión v2.0.231. Estrategia: red primero con cache de respaldo. */
const CACHE = 'sisventas-v2.0.231';
const SHELL = [
  './',
  './index.html',
  './css/app.css',
