/* SisVentas NIXA - Service Worker v2.0.224
   Versión v2.0.224. Estrategia: red primero con cache de respaldo. */
const CACHE = 'sisventas-v2.0.224';
const SHELL = [
  './',
  './index.html',
  './css/app.css',
