/* SisVentas NIXA - Service Worker v2.0.196
   Versión v2.0.196. Estrategia: red primero con cache de respaldo. */
const CACHE = 'sisventas-v2.0.196';
const SHELL = [
  './',
  './index.html',
  './css/app.css',
