/* SisVentas NIXA - Service Worker v2.0.288
   Versión v2.0.288. Estrategia: red primero con cache de respaldo. */
const CACHE = 'sisventas-v2.0.288';
const SHELL = [
  './',
  './index.html',
  './css/app.css',
