/* SisVentas NIXA - Service Worker v2.0.242
   Versión v2.0.242. Estrategia: red primero con cache de respaldo. */
const CACHE = 'sisventas-v2.0.242';
const SHELL = [
  './',
  './index.html',
  './css/app.css',
