/* SisVentas NIXA - Service Worker v2.0.209
   Versión v2.0.209. Estrategia: red primero con cache de respaldo. */
const CACHE = 'sisventas-v2.0.209';
const SHELL = [
  './',
  './index.html',
  './css/app.css',
