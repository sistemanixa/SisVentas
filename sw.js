/* SisVentas NIXA - Service Worker v2.0.266
   Versión v2.0.266. Estrategia: red primero con cache de respaldo. */
const CACHE = 'sisventas-v2.0.266';
const SHELL = [
  './',
  './index.html',
  './css/app.css',
