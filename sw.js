/* SisVentas NIXA - Service Worker v2.0.268
   Versión v2.0.268. Estrategia: red primero con cache de respaldo. */
const CACHE = 'sisventas-v2.0.268';
const SHELL = [
  './',
  './index.html',
  './css/app.css',
