/* SisVentas NIXA - Service Worker v2.0.264
   Versión v2.0.264. Estrategia: red primero con cache de respaldo. */
const CACHE = 'sisventas-v2.0.264';
const SHELL = [
  './',
  './index.html',
  './css/app.css',
