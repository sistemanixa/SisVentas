/* SisVentas NIXA - Service Worker v2.0.233
   Versión v2.0.233. Estrategia: red primero con cache de respaldo. */
const CACHE = 'sisventas-v2.0.233';
const SHELL = [
  './',
  './index.html',
  './css/app.css',
