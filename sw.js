/* SisVentas NIXA - Service Worker v2.0.208
   Versión v2.0.208. Estrategia: red primero con cache de respaldo. */
const CACHE = 'sisventas-v2.0.208';
const SHELL = [
  './',
  './index.html',
  './css/app.css',
