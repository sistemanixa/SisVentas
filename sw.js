/* SisVentas NIXA - Service Worker v2.0.269
   Versión v2.0.269. Estrategia: red primero con cache de respaldo. */
const CACHE = 'sisventas-v2.0.269';
const SHELL = [
  './',
  './index.html',
  './css/app.css',
