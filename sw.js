/* SisVentas NIXA - Service Worker v2.0.247
   Versión v2.0.247. Estrategia: red primero con cache de respaldo. */
const CACHE = 'sisventas-v2.0.247';
const SHELL = [
  './',
  './index.html',
  './css/app.css',
