/* SisVentas NIXA - Service Worker v2.0.287
   Versión v2.0.287. Estrategia: red primero con cache de respaldo. */
const CACHE = 'sisventas-v2.0.287';
const SHELL = [
  './',
  './index.html',
  './css/app.css',
