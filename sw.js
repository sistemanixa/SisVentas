/* SisVentas NIXA - Service Worker v2.0.199
   Versión v2.0.199. Estrategia: red primero con cache de respaldo. */
const CACHE = 'sisventas-v2.0.199';
const SHELL = [
  './',
  './index.html',
  './css/app.css',
