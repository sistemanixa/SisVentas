/* SisVentas NIXA - Service Worker v2.0.304
   Versión v2.0.304. Estrategia: red primero con cache de respaldo. */
const CACHE = 'sisventas-v2.0.304';
const SHELL = [
  './',
  './index.html',
  './css/app.css',
