/* SisVentas NIXA - Service Worker v2.0.201
   Versión v2.0.201. Estrategia: red primero con cache de respaldo. */
const CACHE = 'sisventas-v2.0.201';
const SHELL = [
  './',
  './index.html',
  './css/app.css',
