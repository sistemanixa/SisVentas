/* SisVentas NIXA - Service Worker v2.0.217
   Versión v2.0.217. Estrategia: red primero con cache de respaldo. */
const CACHE = 'sisventas-v2.0.217';
const SHELL = [
  './',
  './index.html',
  './css/app.css',
