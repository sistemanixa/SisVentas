/* SisVentas NIXA - Service Worker v2.0.263
   Versión v2.0.263. Estrategia: red primero con cache de respaldo. */
const CACHE = 'sisventas-v2.0.263';
const SHELL = [
  './',
  './index.html',
  './css/app.css',
