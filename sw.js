/* SisVentas NIXA - Service Worker v2.0.305
   Versión v2.0.305. Estrategia: red primero con cache de respaldo. */
const CACHE = 'sisventas-v2.0.305';
const SHELL = [
  './',
  './index.html',
  './css/app.css',
