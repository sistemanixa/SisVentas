/* SisVentas NIXA - Service Worker v2.0.195
   Versión v2.0.195. Estrategia: red primero con cache de respaldo. */
const CACHE = 'sisventas-v2.0.195';
const SHELL = [
  './',
  './index.html',
  './css/app.css',
