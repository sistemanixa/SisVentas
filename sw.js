/* SisVentas NIXA - Service Worker v2.0.285
   Versión v2.0.285. Estrategia: red primero con cache de respaldo. */
const CACHE = 'sisventas-v2.0.285';
const SHELL = [
  './',
  './index.html',
  './css/app.css',
