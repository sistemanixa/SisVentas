/* SisVentas NIXA - Service Worker v2.0.228
   Versión v2.0.228. Estrategia: red primero con cache de respaldo. */
const CACHE = 'sisventas-v2.0.228';
const SHELL = [
  './',
  './index.html',
  './css/app.css',
