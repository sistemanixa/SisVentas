/* SisVentas NIXA - Service Worker v2.0.306
   Versión v2.0.306. Estrategia: red primero con cache de respaldo. */
const CACHE = 'sisventas-v2.0.306';
const SHELL = [
  './',
  './index.html',
  './css/app.css',
