/* SisVentas NIXA - Service Worker v2.0.286
   Versión v2.0.286. Estrategia: red primero con cache de respaldo. */
const CACHE = 'sisventas-v2.0.286';
const SHELL = [
  './',
  './index.html',
  './css/app.css',
