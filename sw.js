/* SisVentas NIXA - Service Worker v2.0.253
   Versión v2.0.253. Estrategia: red primero con cache de respaldo. */
const CACHE = 'sisventas-v2.0.253';
const SHELL = [
  './',
  './index.html',
  './css/app.css',
