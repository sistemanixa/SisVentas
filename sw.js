/* SisVentas NIXA - Service Worker v2.0.262
   Versión v2.0.262. Estrategia: red primero con cache de respaldo. */
const CACHE = 'sisventas-v2.0.262';
const SHELL = [
  './',
  './index.html',
  './css/app.css',
