/* SisVentas NIXA - Service Worker v2.0.244
   Versión v2.0.244. Estrategia: red primero con cache de respaldo. */
const CACHE = 'sisventas-v2.0.244';
const SHELL = [
  './',
  './index.html',
  './css/app.css',
