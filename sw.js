/* SisVentas NIXA - Service Worker v2.0.239
   Versión v2.0.239. Estrategia: red primero con cache de respaldo. */
const CACHE = 'sisventas-v2.0.239';
const SHELL = [
  './',
  './index.html',
  './css/app.css',
