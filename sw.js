/* SisVentas NIXA - Service Worker v3.6.16
   Estrategia: red primero con cache de respaldo. */
const CACHE = 'sisventas-v3.6.16';
const SHELL = [
  './',
  './index.html',
  './css/app.css?v=3.6.16',
  './css/v3-preview.css',
  './js/app.js',
  './js/modules/budget-proposals.js?v=3.6.16',
  ...
  './js/modules/budget-exterior.js?v=3.6.16',
  './js/modules/product-query-guard.js?v=3.6.16',
