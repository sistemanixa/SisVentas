/* SisVentas NIXA - Service Worker v2.0.194
   Versión v2.0.194. Estrategia: red primero con cache de respaldo. */
const CACHE = 'sisventas-v2.0.194';
const SHELL = [
  './',
  './index.html',
  './css/app.css',
