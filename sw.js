/* SisVentas NIXA - Service Worker v2.0.206
   Versión v2.0.206. Estrategia: red primero con cache de respaldo. */
const CACHE = 'sisventas-v2.0.206';
const SHELL = [
  './',
  './index.html',
  './css/app.css',
