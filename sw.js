/* SisVentas NIXA - Service Worker v2.0.203
   Versión v2.0.203. Estrategia: red primero con cache de respaldo. */
const CACHE = 'sisventas-v2.0.203';
const SHELL = [
  './',
  './index.html',
  './css/app.css',
