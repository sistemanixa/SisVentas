/* SisVentas NIXA - Service Worker v2.0.211
   Versión v2.0.211. Estrategia: red primero con cache de respaldo. */
const CACHE = 'sisventas-v2.0.211';
const SHELL = [
  './',
  './index.html',
  './css/app.css',
