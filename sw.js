/* SisVentas NIXA - Service Worker v2.0.207
   Versión v2.0.207. Estrategia: red primero con cache de respaldo. */
const CACHE = 'sisventas-v2.0.207';
const SHELL = [
  './',
  './index.html',
  './css/app.css',
