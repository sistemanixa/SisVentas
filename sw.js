/* SisVentas NIXA - Service Worker v2.0.267
   Versión v2.0.267. Estrategia: red primero con cache de respaldo. */
const CACHE = 'sisventas-v2.0.267';
const SHELL = [
  './',
  './index.html',
  './css/app.css',
