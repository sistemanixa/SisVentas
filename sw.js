/* SisVentas NIXA - Service Worker v2.0.258
   Versión v2.0.258. Estrategia: red primero con cache de respaldo. */
const CACHE = 'sisventas-v2.0.258';
const SHELL = [
  './',
  './index.html',
  './css/app.css',
