/* SisVentas NIXA - Service Worker v2.0.251
   Versión v2.0.251. Estrategia: red primero con cache de respaldo. */
const CACHE = 'sisventas-v2.0.251';
const SHELL = [
  './',
  './index.html',
  './css/app.css',
