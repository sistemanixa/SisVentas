/* SisVentas NIXA - Service Worker v2.0.300
   Versión v2.0.300. Estrategia: red primero con cache de respaldo. */
const CACHE = 'sisventas-v2.0.300';
const SHELL = [
  './',
  './index.html',
  './css/app.css',
