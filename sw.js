/* SisVentas NIXA - Service Worker v2.0.202
   Versión v2.0.202. Estrategia: red primero con cache de respaldo. */
const CACHE = 'sisventas-v2.0.202';
const SHELL = [
  './',
  './index.html',
  './css/app.css',
