/* SisVentas NIXA - Service Worker v3.7.3
   Estrategia: red primero con cache de respaldo. */
const CACHE = 'sisventas-v3.7.3';
const SHELL = [
  './',
  './index.html',
  './css/app.css?v=3.7.3',
  ...
  './js/modules/budget-exterior.js?v=3.7.0',
  ...
  './js/modules/purchase-orders.js?v=3.7.2-listas-compras-4',
