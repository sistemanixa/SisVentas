/* SisVentas NIXA - Service Worker v2.0.273
   Versión v2.0.273. Estrategia: red primero con cache de respaldo. */
const CACHE = 'sisventas-v2.0.273';
const SHELL = [
  './',
  './index.html',
  './css/app.css',
