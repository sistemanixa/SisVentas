/* SisVentas NIXA - Service Worker v2.0.241
   Versión v2.0.241. Estrategia: red primero con cache de respaldo. */
const CACHE = 'sisventas-v2.0.241';
const SHELL = [
  './',
  './index.html',
  './css/app.css',
