/* SisVentas NIXA - Service Worker v2.0.230
   Versión v2.0.230. Estrategia: red primero con cache de respaldo. */
const CACHE = 'sisventas-v2.0.230';
const SHELL = [
  './',
  './index.html',
  './css/app.css',
