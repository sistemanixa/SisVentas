/* SisVentas NIXA - Service Worker v2.0.274
   Versión v2.0.274. Estrategia: red primero con cache de respaldo. */
const CACHE = 'sisventas-v2.0.274';
const SHELL = [
  './',
  './index.html',
  './css/app.css',
