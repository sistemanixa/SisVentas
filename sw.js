/* SisVentas NIXA - Service Worker v2.0.310
   Versión v2.0.310. Estrategia: red primero con cache de respaldo. */
const CACHE = 'sisventas-v2.0.310';
const SHELL = [
  './',
  './index.html',
  './css/app.css',
