/* SisVentas NIXA - Service Worker v2.0.191
   Versión v2.0.191. Estrategia: red primero con cache de respaldo. */
const CACHE = 'sisventas-v2.0.191';
const SHELL = [
  './',
  './index.html',
  './css/app.css',
