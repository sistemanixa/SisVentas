/* SisVentas NIXA - Service Worker v2.0.223
   Versión v2.0.223. Estrategia: red primero con cache de respaldo. */
const CACHE = 'sisventas-v2.0.223';
const SHELL = [
  './',
  './index.html',
  './css/app.css',
