/* SisVentas NIXA - Service Worker v2.0.259
   Versión v2.0.259. Estrategia: red primero con cache de respaldo. */
const CACHE = 'sisventas-v2.0.259';
const SHELL = [
  './',
  './index.html',
  './css/app.css',
