/* SisVentas NIXA - Service Worker v2.0.204
   Versión v2.0.204. Estrategia: red primero con cache de respaldo. */
const CACHE = 'sisventas-v2.0.204';
const SHELL = [
  './',
  './index.html',
  './css/app.css',
