/* SisVentas NIXA - Service Worker v2.0.243
   Versión v2.0.243. Estrategia: red primero con cache de respaldo. */
const CACHE = 'sisventas-v2.0.243';
const SHELL = [
  './',
  './index.html',
  './css/app.css',
