/* SisVentas NIXA - Service Worker v2.0.236
   Versión v2.0.236. Estrategia: red primero con cache de respaldo. */
const CACHE = 'sisventas-v2.0.236';
const SHELL = [
  './',
  './index.html',
  './css/app.css',
