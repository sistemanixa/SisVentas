/* SisVentas NIXA - Service Worker v2.0.193
   Versión v2.0.193. Estrategia: red primero con cache de respaldo. */
const CACHE = 'sisventas-v2.0.193';
const SHELL = [
  './',
  './index.html',
  './css/app.css',
