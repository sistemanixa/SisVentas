/* SisVentas NIXA - Service Worker v2.0.212
   Versión v2.0.212. Estrategia: red primero con cache de respaldo. */
const CACHE = 'sisventas-v2.0.212';
const SHELL = [
  './',
  './index.html',
  './css/app.css',
