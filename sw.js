/* SisVentas NIXA - Service Worker v2.0.225
   Versión v2.0.225. Estrategia: red primero con cache de respaldo. */
const CACHE = 'sisventas-v2.0.225';
const SHELL = [
  './',
  './index.html',
  './css/app.css',
