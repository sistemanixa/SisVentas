/* SisVentas NIXA - Service Worker v2.0.232
   Versión v2.0.232. Estrategia: red primero con cache de respaldo. */
const CACHE = 'sisventas-v2.0.232';
const SHELL = [
  './',
  './index.html',
  './css/app.css',
