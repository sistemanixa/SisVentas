/* SisVentas NIXA - Service Worker v2.0.280
   Versión v2.0.280. Estrategia: red primero con cache de respaldo. */
const CACHE = 'sisventas-v2.0.280';
const SHELL = [
  './',
  './index.html',
  './css/app.css',
