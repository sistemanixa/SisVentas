/* SisVentas NIXA - Service Worker v2.0.238
   Versión v2.0.238. Estrategia: red primero con cache de respaldo. */
const CACHE = 'sisventas-v2.0.238';
const SHELL = [
  './',
  './index.html',
  './css/app.css',
