/* SisVentas NIXA - Service Worker v2.0.221
   Versión v2.0.221. Estrategia: red primero con cache de respaldo. */
const CACHE = 'sisventas-v2.0.221';
const SHELL = [
  './',
  './index.html',
  './css/app.css',
