/* SisVentas NIXA - Service Worker v2.0.222
   Versión v2.0.222. Estrategia: red primero con cache de respaldo. */
const CACHE = 'sisventas-v2.0.222';
const SHELL = [
  './',
  './index.html',
  './css/app.css',
