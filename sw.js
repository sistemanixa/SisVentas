/* SisVentas NIXA - Service Worker v2.0.256
   Versión v2.0.256. Estrategia: red primero con cache de respaldo. */
const CACHE = 'sisventas-v2.0.256';
const SHELL = [
  './',
  './index.html',
  './css/app.css',
