/* SisVentas NIXA - Service Worker v2.0.249
   Versión v2.0.249. Estrategia: red primero con cache de respaldo. */
const CACHE = 'sisventas-v2.0.249';
const SHELL = [
  './',
  './index.html',
  './css/app.css',
