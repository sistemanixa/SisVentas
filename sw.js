/* SisVentas NIXA - Service Worker v2.0.192
   Versión v2.0.192. Estrategia: red primero con cache de respaldo. */
const CACHE = 'sisventas-v2.0.192';
const SHELL = [
  './',
  './index.html',
  './css/app.css',
