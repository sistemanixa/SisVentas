/* SisVentas NIXA - Service Worker v2.0.302
   Versión v2.0.302. Estrategia: red primero con cache de respaldo. */
const CACHE = 'sisventas-v2.0.302';
const SHELL = [
  './',
  './index.html',
  './css/app.css',
