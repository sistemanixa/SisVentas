/* SisVentas NIXA - Service Worker v2.0.298
   Versión v2.0.298. Estrategia: red primero con cache de respaldo. */
const CACHE = 'sisventas-v2.0.298';
const SHELL = [
  './',
  './index.html',
  './css/app.css',
