/* SisVentas NIXA - Service Worker v2.0.291
   Versión v2.0.291. Estrategia: red primero con cache de respaldo. */
const CACHE = 'sisventas-v2.0.291';
const SHELL = [
  './',
  './index.html',
  './css/app.css',
