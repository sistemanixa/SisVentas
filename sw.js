/* SisVentas NIXA - Service Worker v2.0.309
   Versión v2.0.309. Estrategia: red primero con cache de respaldo. */
const CACHE = 'sisventas-v2.0.309';
const SHELL = [
  './',
  './index.html',
  './css/app.css',
