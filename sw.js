/* SisVentas NIXA - Service Worker v2.0.250
   Versión v2.0.250. Estrategia: red primero con cache de respaldo. */
const CACHE = 'sisventas-v2.0.250';
const SHELL = [
  './',
  './index.html',
  './css/app.css',
