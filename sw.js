/* SisVentas NIXA - Service Worker v2.0.235
   Versión v2.0.235. Estrategia: red primero con cache de respaldo. */
const CACHE = 'sisventas-v2.0.235';
const SHELL = [
  './',
  './index.html',
  './css/app.css',
