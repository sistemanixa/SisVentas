/* SisVentas NIXA - Service Worker v2.0.265
   Versión v2.0.265. Estrategia: red primero con cache de respaldo. */
const CACHE = 'sisventas-v2.0.265';
const SHELL = [
  './',
  './index.html',
  './css/app.css',
