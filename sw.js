/* SisVentas NIXA - Service Worker v2.0.213
   Versión v2.0.213. Estrategia: red primero con cache de respaldo. */
const CACHE = 'sisventas-v2.0.213';
const SHELL = [
  './',
  './index.html',
  './css/app.css',
