/* SisVentas NIXA - Service Worker v2.0.214
   Versión v2.0.214. Estrategia: red primero con cache de respaldo. */
const CACHE = 'sisventas-v2.0.214';
const SHELL = [
  './',
  './index.html',
  './css/app.css',
