/* SisVentas NIXA - Service Worker v2.0.210
   Versión v2.0.210. Estrategia: red primero con cache de respaldo. */
const CACHE = 'sisventas-v2.0.210';
const SHELL = [
  './',
  './index.html',
  './css/app.css',
