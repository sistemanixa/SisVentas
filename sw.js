/* SisVentas NIXA - Service Worker v2.0.261
   Versión v2.0.261. Estrategia: red primero con cache de respaldo. */
const CACHE = 'sisventas-v2.0.261';
const SHELL = [
  './',
  './index.html',
  './css/app.css',
