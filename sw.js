/* SisVentas NIXA - Service Worker v2.0.260
   Versión v2.0.260. Estrategia: red primero con cache de respaldo. */
const CACHE = 'sisventas-v2.0.260';
const SHELL = [
  './',
  './index.html',
  './css/app.css',
