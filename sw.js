/* SisVentas NIXA - Service Worker v2.0.216
   Versión v2.0.216. Estrategia: red primero con cache de respaldo. */
const CACHE = 'sisventas-v2.0.216';
const SHELL = [
  './',
  './index.html',
  './css/app.css',
