/* SisVentas NIXA - Service Worker v2.0.219
   Versión v2.0.219. Estrategia: red primero con cache de respaldo. */
const CACHE = 'sisventas-v2.0.219';
const SHELL = [
  './',
  './index.html',
  './css/app.css',
