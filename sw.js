/* SisVentas NIXA - Service Worker v2.0.240
   Versión v2.0.240. Estrategia: red primero con cache de respaldo. */
const CACHE = 'sisventas-v2.0.240';
const SHELL = [
  './',
  './index.html',
  './css/app.css',
