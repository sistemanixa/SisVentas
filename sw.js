/* SisVentas NIXA - Service Worker v2.0.293
   Versión v2.0.293. Estrategia: red primero con cache de respaldo. */
const CACHE = 'sisventas-v2.0.293';
const SHELL = [
  './',
  './index.html',
  './css/app.css',
