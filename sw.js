/* SisVentas NIXA - Service Worker v2.0.215
   Versión v2.0.215. Estrategia: red primero con cache de respaldo. */
const CACHE = 'sisventas-v2.0.215';
const SHELL = [
  './',
  './index.html',
  './css/app.css',
