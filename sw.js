/* SisVentas NIXA - Service Worker v2.0.257
   Versión v2.0.257. Estrategia: red primero con cache de respaldo. */
const CACHE = 'sisventas-v2.0.257';
const SHELL = [
  './',
  './index.html',
  './css/app.css',
