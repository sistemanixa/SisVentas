/* SisVentas NIXA - Service Worker v2.0.308
   Versión v2.0.308. Estrategia: red primero con cache de respaldo. */
const CACHE = 'sisventas-v2.0.308';
const SHELL = [
  './',
  './index.html',
  './css/app.css',
