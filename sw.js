/* SisVentas NIXA - Service Worker v2.0.227
   Versión v2.0.227. Estrategia: red primero con cache de respaldo. */
const CACHE = 'sisventas-v2.0.227';
const SHELL = [
  './',
  './index.html',
  './css/app.css',
