/* SisVentas NIXA - Service Worker v2.0.234
   Versión v2.0.234. Estrategia: red primero con cache de respaldo. */
const CACHE = 'sisventas-v2.0.234';
const SHELL = [
  './',
  './index.html',
  './css/app.css',
