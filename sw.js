/* SisVentas NIXA - Service Worker v2.0.237
   Versión v2.0.237. Estrategia: red primero con cache de respaldo. */
const CACHE = 'sisventas-v2.0.237';
const SHELL = [
  './',
  './index.html',
  './css/app.css',
