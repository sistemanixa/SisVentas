/* SisVentas NIXA - Service Worker v2.0.282
   Versión v2.0.282. Estrategia: red primero con cache de respaldo. */
const CACHE = 'sisventas-v2.0.282';
const SHELL = [
  './',
  './index.html',
  './css/app.css',
