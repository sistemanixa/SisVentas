/* SisVentas NIXA - Service Worker v2.0.229
   Versión v2.0.229. Estrategia: red primero con cache de respaldo. */
const CACHE = 'sisventas-v2.0.229';
const SHELL = [
  './',
  './index.html',
  './css/app.css',
