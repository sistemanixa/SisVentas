/* SisVentas NIXA - Service Worker v2.0.294
   Versión v2.0.294. Estrategia: red primero con cache de respaldo. */
const CACHE = 'sisventas-v2.0.294';
const SHELL = [
  './',
  './index.html',
  './css/app.css',
