/* SisVentas NIXA - Service Worker v2.0.252
   Versión v2.0.252. Estrategia: red primero con cache de respaldo. */
const CACHE = 'sisventas-v2.0.252';
const SHELL = [
  './',
  './index.html',
  './css/app.css',
