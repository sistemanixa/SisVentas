/* SisVentas NIXA - Service Worker v2.0.278
   Versión v2.0.278. Estrategia: red primero con cache de respaldo. */
const CACHE = 'sisventas-v2.0.278';
const SHELL = [
  './',
  './index.html',
  './css/app.css',
