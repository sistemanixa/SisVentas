/* SisVentas NIXA - Service Worker v2.0.303
   Versión v2.0.303. Estrategia: red primero con cache de respaldo. */
const CACHE = 'sisventas-v2.0.303';
const SHELL = [
  './',
  './index.html',
  './css/app.css',
