/* SisVentas NIXA - Service Worker v2.0.245
   Versión v2.0.245. Estrategia: red primero con cache de respaldo. */
const CACHE = 'sisventas-v2.0.245';
const SHELL = [
  './',
  './index.html',
  './css/app.css',
